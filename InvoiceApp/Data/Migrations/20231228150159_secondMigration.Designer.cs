...
namespace InvoiceApp.Data.Migrations
{
    ...
    [Migration("20231228150159_secondMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceApp.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("InvoiceApp.Data.Invoice", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InvoiceApp.Data.InvoiceLineItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InvoiceApp.Data.InvoiceTerms", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InvoiceApp.Data.Invoice", b =>
                {
                    b.HasOne("InvoiceApp.Data.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("InvoiceApp.Data.InvoiceTerms", "InvoiceTerms")
                        .WithMany()
            ...
            modelBuilder.Entity("InvoiceApp.Data.InvoiceLineItem", b =>
                {
                    b.HasOne("InvoiceApp.Data.Invoice", "Invoice")
